...
float CVector3f::Distance(CVector3f vPoint2)
{
	float distance = 0;

	CVector3f vPoint1 = *this;
...
bool CVector3f::isPerendicular(CVector3f v)
{
	return (*this * v == 0);
}

void CVector3f::Lerp(CVector3f a, CVector3f b, float t)
{
